...
import com.example.android.kdquangdinh.databinding.UpdateProductLayoutBinding
...
class UpdateProductDialogFragment : DialogFragment() {
    ...
    private var _binding: UpdateProductLayoutBinding? = null
    private val binding get() = _binding!!
    private lateinit var mainViewModel: MainViewModel

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {

        _binding = UpdateProductLayoutBinding.inflate(LayoutInflater.from(context))

        mainViewModel = ViewModelProvider(requireActivity()).get(MainViewModel::class.java)

        binding.product = mainViewModel.updatedProduct
            ...
            builder.setView(binding.root)
                ...
                .setPositiveButton(R.string.ok,
                    DialogInterface.OnClickListener { dialog, id ->
                        try {
                            mainViewModel.updateProduct(mainViewModel.token, Product(
    ...
    companion object {
        const val TAG = "UpdateProductDialogFragment"
    }
}